...
If the filename ends with `.xz` you first need to decompress it: `xz -dv data.csv.xz`. Note that this will increase the size by 225%.
...
| conv_depth_norm                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Similar to `conv_depth` but normalized by the maximum `conv_depth`. Will be a float between 0 (first layers) .. 1 (towards head). |
...
| Pretraining-Dataset                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Name of the pretraining dataset(s) if pretrained. Multiple data sets are separated by commas. |
| Training-Dataset                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Name of the training dataset(s). Multiple data sets are separated by commas.|
| Datatype                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Visual, manual categorization of the training data sets. |
